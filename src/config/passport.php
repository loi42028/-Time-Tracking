...
return [
    ...
    */
    ...
    'default_scopes' => ['my_account','my_team_view'],

    'scopes' => [
        'my_account' => 'Access my account',
        'my_team_view' => 'View information of my team',
        'admin_system' => 'Admin the system',
        'admin_accounts' => 'Admin the accounts'
    ]    
